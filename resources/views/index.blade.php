...
<body>
    ...
    <div style="" id="formules">
        <div class="align-center">
            ...
            <p class="big-text">Nos assurances sont créées <b>sur mesure</b>. Trouvez celle qui <b>correspond à vos besoins</b> dès
                aujourd’hui.</p>
            <div class="row">
                <hr>
                <div class="col">
    ...
    <div style="" id="engagement">
        ...
        <p class="big-text">Notre équipe répond à vos questions et <b>vous accompagne au quotidien !</b> <br/>Vous pouvez toujours compter sur
                nous.</p>
    ...
    <div id="devis">
        <div class="align-center">
            ...
            <p class="big-text">C’est <b>gratuit, sans engagement,</b> et il faut <b>moins de<br> 2 minutes</b> pour le faire !</p>
