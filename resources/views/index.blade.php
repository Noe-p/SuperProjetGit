...
<body>
    ...
    <div class="row">
      <div class="col-6">
        ...
        <div class="justify-content-center">
          <button type="button" id="btn-assurrance" class="btn btn-outline justify-content-center" data-toggle="modal"
  ...
  <div style="" id="formules">
    <div class="align-center">
      ...
      <div class="row">
        ...
        <div class="col">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            xmlns:serif="http://www.serif.com/" width="115px" height="115px" viewBox="0 0 600 600" version="1.1"
            xml:space="preserve"
        ...
        <div class="col">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cars" role="img"
            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="svg-inline--fa fa-cars fa-w-20 fa-3x"
            style="width:110px">
            <path fill="#84aa72"
                ...
                <form method="POST" action="{{url('/devis')}}">
                  ...
                  <div class="form-group">
                    <label class="form-group has-float-label">
                      <input type="text" class="form-control" id="ds-name" name="ds_name" aria-describedby="ds-name"
                        required>
  ...
  <div style="" id="formulaire">
    <img width="40px" height="40px" src="{{asset('/img/assur.png')}}" />
      ...
      <div class="col-12 col-md">
        <a class="text-muted" href="#" style="color: black">
          <svg class="footer-logo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            xmlns:serif="http://www.serif.com/" width="90%" height="90%" viewBox="0 0 6168 1500" version="1.1"
            xml:space="preserve"
